...
import { getDanhSachTheLoai } from "../../store/reducer/TheLoaiReducer";
...
export const layDanhSachTheLoaiAction = async (dispatch) => {
  try {
    const result = await apiKey.get("api/Theloais/LayDanhSachTheLoai");

    dispatch(getDanhSachTheLoai(result.data.data))
  } catch (error) {
    return false;
  }
