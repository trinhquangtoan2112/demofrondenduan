...
function Story(props) {
  ...
  return (
    <Link
      ...
      className="flex border border-gray-300 rounded-lg p-4 shadow-lg hover:shadow-2xl transition-shadow duration-300"
    >
      ...
      <div className="w-5/6 pl-4">
        ...
        <div className="text-gray-700 mb-2 line-clamp-2">
          {data?.moTa ? parse(data.moTa) : null}
        </div>
        <div className="flex justify-between items-center text-sm">
          ...
          <span className="border border-primary text-primary px-2 py-1 rounded">
            {data.tenTheLoai}
          </span>
        </div>
      </div>
